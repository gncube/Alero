...
<dnn:DnnCssInclude ID="bootstrapCSS" runat="server" FilePath="assets/css/bootstrap.min.css" PathNameAlias="SkinPath" />
...
<div id="body" class="header-fixed">
    ...
    <div id="contentWrapper-fixed-top">
        ...
        <!-- Intro Section -->
        <div id="TopPane" class="container" runat="server"></div>

        <div class="container">            
            <div id="LeftPane" class="col-md-3" runat="server">
